...
if(!$result){
    ...
    while ($row = mysqli_fetch_assoc($result)){
        if($row['image'] == null || $row['image'] ==''){
            ...
            $thum_Image = "./image/slide/".$row['image'];
        }
		?>
						            ...
						            <div class="slotholder" style="width:100%;height:100%;" data-duration="undefined" data-zoomstart="undefined" data-zoomend="undefined" data-rotationstart="undefined" data-rotationend="undefined" data-ease="undefined" data-bgpositionend="undefined" data-bgposition="undefined" data-kenburns="undefined" data-easeme="undefined" data-bgfit="undefined" data-bgfitend="undefined" data-owidth="undefined" data-oheight="undefined">
													<div class="tp-bgimg defaultimg" data-lazyload="undefined" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat" data-lazydone="undefined" src="<?php echo $thum_Image;?>" data-src="<?php echo $thum_Image;?>" style="background-color: rgba(0, 0, 0, 0); background-repeat: no-repeat; background-image: url('<?php echo $thum_Image;?>'); background-size: cover; background-position: center center; width: 100%; height: 100%; opacity: 1; visibility: inherit;">
													</div>
												</div>
									...
									<div class="single-item">
										...
										<div class="single-item-body">
											...
											<p class="single-item-price">
												<span><?php echo $row['promotion_price'];?></span>
											</p>
										</div>
